...
export class OnnxDumpData {
  constructor(modelName, graphOptimizationLevel, dumpOrCmp) {
    // mode 0: will not create any  data file, output a result file. mode 1: generate data file, to use these file in mode. mode 2: copy file generated by mode 1 modelDir.
    ...
    // modelDir: directory of .onnx model file. When useFile, include weights and i/o data.
    // optimizedModelName: optimized, json format ort model file.
